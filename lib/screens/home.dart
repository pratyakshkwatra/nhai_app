...
class SurveyVehicleDataScreen extends StatefulWidget {
  const SurveyVehicleDataScreen({super.key});
...
final videoPlayerController =
    VideoPlayerController.asset("assets/output_1080p.mp4");
...
class _SurveyVehicleDataScreenState extends State<SurveyVehicleDataScreen> {
  ...
  Future<List<List<dynamic>>> loadCsvData() async {
    final rawData = await rootBundle.loadString('assets/output_matched.csv');
